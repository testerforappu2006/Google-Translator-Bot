...
async def callback(client, query_callback):
    if query_callback.data == "trdelete":
       ...
       await query_callback.message.edit_text(Translation.CREDITS, reply_markup=InlineKeyboardMarkup( [[ InlineKeyboardButton("main channel", url="https://t.me/thegreatmoviecentre") ],[ InlineKeyboardButton("suggestion channel", url="https://t.me/thegreatsuggestion") ],[ InlineKeyboardButton("help channel", url="https://t.me/thegreathelp") ],[ InlineKeyboardButton("update channel", url="https://t.me/thegreatmovieupdates") ]] ))   
